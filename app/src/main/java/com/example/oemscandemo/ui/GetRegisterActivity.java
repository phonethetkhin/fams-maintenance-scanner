...
public class GetRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RelativeLayout noRegisterLayout, registerLayout, registerFailLayout, deviceInActiveLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceInActiveLayout = findViewById(R.id.device_inactive_layout);
