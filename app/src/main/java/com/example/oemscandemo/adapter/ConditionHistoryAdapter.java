...
public class ConditionHistoryAdapter extends BaseAdapter {
    private List<ConditionScheduleMaintenanceDetail> detailList;
    private Context context;

    public ConditionHistoryAdapter(List<ConditionScheduleMaintenanceDetail> detailList, Context context) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        ConditionScheduleMaintenanceDetail maintenanceDetail = (ConditionScheduleMaintenanceDetail) getItem(position);
